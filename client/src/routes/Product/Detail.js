...
function ProductDetail(props) {
    ...
    const fetchSuggestProduct = async (_product) => {
        try {
            ...
            setSuggestProducts(
                resp.data
                    .filter((_item) => _item._id !== _product._id)
                    .slice(0, 5),
            );
        } catch (e) {
            toast.error(
                            ...
                            <div>
                                <div className="border border-gray-200 rounded-xl mb-4 overflow-hidden">
                                    ...
                                    <div className="p-3">
                                        <ul>
                                            <li>
                                                - Uy tín 20 năm xây dựng và phát
                                                triển
                                            </li>
                                            <li>- Sản phẩm chính hãng 100%</li>
                                            <li>
                                                - Trả góp lãi suất 0% toàn bộ
                                                giỏ hàng
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                - Bảo hành tận nơi cho doanh
                                                nghiệp
                                            </li>
                                            <li>
                                                - Ưu đãi riêng cho học sinh sinh
                                                viên
                                            </li>
                                            <li>
                                                - Vệ sinh miễn phí trọn đời PC,
                                                Laptop
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div className="bg-white rounded-xl px-4 py-2 col-span-4">
                        <div className="flex">
                            ...
                            <div
                                ...
                                onClick={() =>
                                    setActiveSection(SECTION.COMMENT)
                                }
                            >
                                Bình luận
                            </div>
